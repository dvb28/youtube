...
export const BellIcon = ({ isOn, ...props }) => {
    const path = isOn
        ? "M10,20h4c0,1.1-0.9,2-2,2S10,21.1,10,20z M20,17.35V19H4v-1.65l2-1.88v-5.15c0-2.92,1.56-5.22,4-5.98V3.96 c0-1.42,1.49-2.5,2.99-1.76C13.64,2.52,14,3.23,14,3.96l0,0.39c2.44,0.75,4,3.06,4,5.98v5.15L20,17.35z M19"
    ...
    return (
        <div style={{ ...props }}>
            ...
            >
                <g className="style-scope yt-icon">
                    <path d={path} className="style-scope yt-icon"></path>
                </g>
            </svg>
        </div>
    );
...
export const RendererIcon = ({ isOn, ...props }) => {
    const path = isOn
        ? "M18,8.83V5H2v14h16v-5.83L22,15V7L18,8.83z M14,13h-3v3H9v-3H6v-2h3V8h2v3h3V13z"
...
export const UpLoadVideoIcon = ({ isOn, ...props }) => {
    return (
        <div style={{ ...props }}>
            <svg
                viewBox="0 0 24 24"
...
export const UserChanelIcon = ({ ...props }) => {
    return (
        <div style={{ ...props }}>
            <svg
                viewBox="0 0 24 24"
...
export const YoutubeStudioIcon = ({ ...props }) => {
    return (
        <div style={{ ...props }}>
            <svg
                viewBox="0 0 24 24"
...
export const SwapAccountIcon = ({ ...props }) => {
    return (
        <div style={{ ...props }}>
            <svg
                viewBox="0 0 24 24"
...
export const UserDefenderIcon = ({ ...props }) => {
    return (
        <div style={{ ...props }}>
            <svg
                viewBox="0 0 24 24"
...
export const UserCompactIcon = ({ ...props }) => {
    return (
        <div style={{ ...props }}>
            <svg
                viewBox="0 0 24 24"
...
export const StreamingIcon = ({ ...props }) => {
    return (
        <div style={{ ...props }}>
            <svg
                viewBox="0 0 24 24"
...
export const AddAcountIcon = ({ ...props }) => {
    return (
        <div style={{ ...props }}>
            <svg
                viewBox="0 0 24 24"
...
export const CloseIcon = ({ ...props }) => {
    return (
        <div style={{ ...props}}>
            <svg
                class="help-panel-header__close-icon text-[#444746]"
                aria-hidden="true"
                viewBox="0 0 48 48"
            >
